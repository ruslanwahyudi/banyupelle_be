    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="breadcrumb-holder">
                <h1 class="main-title float-left">Tambah Identitas Layanan</h1>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3><i class="fa fa-plus"></i> Tambah Identitas Layanan</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('layanan.identitas.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                ...
                                <a href="{{ route('layanan.identitas') }}" class="btn btn-secondary">Kembali</a>
                            </div>
                        </div>
                    </form>
                </div>
