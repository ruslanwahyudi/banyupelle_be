        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="card mb-3">
                <div class="card-header">
                    <h3><i class="fa fa-check-square-o"></i> Tambah Register Surat</h3>
                </div>

                <div class="card-body">
                    <form id="registerSuratForm" action="{{ route('adm.register_surat.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="nomor_surat" class="form-label">Nomor Surat <span class="text-danger"></span></label>
                                    <input type="text" readonly class="form-control @error('nomor_surat') is-invalid @enderror" id="nomor_surat" name="" value="Generated by System">
                                    @error('nomor_surat')
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control" id="kategori_surat_id" name="kategori_surat_id" required>
                                        ...
                                        @foreach($kategoriSurat as $kategori)
                                            <option value="{{ $kategori->id }}" {{ old('kategori_surat_id') == $kategori->id ? 'selected' : '' }}>
                                                {{ $kategori->nama }}
                                            </option>
                                        @endforeach
                                    </select>
